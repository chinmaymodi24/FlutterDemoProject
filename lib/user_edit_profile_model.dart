...
UserEditProfileModel userModelFromJson(String str) =>
    UserEditProfileModel.fromJson(json.decode(str));

String userModelToJson(UserEditProfileModel data) => json.encode(data.toJson());
